...
class _SubCategoryWidgetState extends State<SubCategoryWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<ProductListScreenController>(init: ProductListScreenController(),builder: (controller) {
      return SafeArea(
          child: Obx(
                () =>
                Scaffold(
                                ...
                                if (controller.subData.isEmpty) {
                                  ...
                                  i++) {
                                    if (!isNullEmptyOrFalse(controller
                                      ...
                                      List data = [];
                                      data.add(controller
                                          .subData[controller.subDataIndex
                                          .value]
                                          .fields![i]
                                          .id);
                                      if (!isNullEmptyOrFalse(controller
                                    ...
                                    print(
                                        "${controller.subData[controller
                                            .subDataIndex.value].fields![i]
                                            .values}==> ${controller
                                            .subData[controller.subDataIndex
                                            .value].fields![i].isChecked}");
