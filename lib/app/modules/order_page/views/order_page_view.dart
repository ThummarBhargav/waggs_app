          ...
          children: [
            Expanded(
              child: GroupedListView<dynamic, String>(
                ...
                groupBy: (element) => element["GroupBy"].toString().split("_")[0],
                    ...
                    child: Row(
                      children: [
                        Padding(
                          ...
                          child: Text(
                            "ORDER #" + value.toString().split("_")[0],
                                ...
                                Column(
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: Text(
                                        orderData.product!.sellerId!.companyName
                                            .toString(),
                                        style: TextStyle(
                                            color: Colors.black,
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      "₹" +
                                          orderData.product!.price.toString() +
                                          "/ unit",
                                      style: TextStyle(
                                          color: Colors.black,
                                          fontWeight: FontWeight.bold),
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Text(
                                          " ₹" +
                                              orderData.product!.discountedPrice
                                                  .toString(),
                                          style: TextStyle(
                                              color: Colors.black,
                                              fontWeight: FontWeight.bold),
