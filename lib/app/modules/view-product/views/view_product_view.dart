                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              padding: const EdgeInsets.only(
                                                  left: 8.0),
                                              child: Text(
                                                "You Save : \u{20B9}${controller
                                                    .data.price! - controller.data
                                                    .discountedPrice!}"
