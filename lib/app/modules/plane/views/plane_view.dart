                            ...
                            children: [
                              Container(
                                ...
                                child: GridView.builder(
                                    itemCount: controller.planList
                                        .length,
                                    scrollDirection: Axis.horizontal,
                                    shrinkWrap: true,
                                    itemBuilder: (context, index) {
                                      print('${controller.planList[index]}');
                                      return  Container(
                                        ...
                                        child: Column(
                                          children: [
                                            Stack(
                                              children: [
                                                ...
                                                Container(
                                                  ...
                                                  child: Center(child: Text("${controller.planList[index].name}",
                                            ...
                                            SizedBox(height: 10,),
                                            Container(
                                              child: Text("\u{20B9}${controller.planList[index].amount}.00",
                                                style: GoogleFonts.raleway(
                                                  color: Colors.orange,
                                                  fontWeight: FontWeight.bold,
                                                  fontSize: 20,
                                            ...
                                            SizedBox(height: 5,),
                                            Container(
                                              child: Text("FOR ${controller.planList[index].validity} MONTHS",
                                                style: GoogleFonts.roboto(
                                                    fontWeight: FontWeight.bold,
                                                    color: Colors.black,
                                                    fontSize: 16
