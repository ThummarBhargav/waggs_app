...
class MyAccountNewChangedAndOldPasswordChangeView
    extends GetView<MyAccountNewChangedAndOldPasswordChangeController> {
  const MyAccountNewChangedAndOldPasswordChangeView({Key? key})
      : super(key: key);
  @override
