...
class ViewAllMyCartView extends GetView<ViewAllMyCartController> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ViewAllMyCartController>(
        init: ViewAllMyCartController(),
        builder: (controller) {
          return SafeArea(
              child: Obx(() => Scaffold(
                                    ...
                                    Container(
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          Expanded(
                                            child: Text(
                                              "SubScribe To Our New Sletter And Receive Special News And Offers",
                                              style: GoogleFonts.raleway(
                                                  fontSize: 12,
                                                  color: Colors.grey),
                                            ),
                                      ...
                                      child: Row(
                                        children: [
                                          Checkbox(
                                              activeColor: Colors.orange,
                                              onChanged: (value) {
                                                controller.detailCheckBox
                                                    .value = value as bool;
                                              },
                                              value: controller
                                                  .detailCheckBox.value),
                                          Expanded(
                                            child: Text(
